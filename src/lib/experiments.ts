...
export const experiments: Experiment[] = [
  ...
  { id: 'texforge', name: 'Texforge', number: 'EXP-001', status: 'active', essenceVar: '--texforge', essenceHex: '#e0a458', github: 'https://github.com/UniverLab/texforge', bg: 'forge', install: installer('texforge'), hasDocs: true },
  { id: 'gitkit', name: 'Gitkit', number: 'EXP-002', status: 'active', essenceVar: '--gitkit', essenceHex: '#7ee081', github: 'https://github.com/UniverLab/gitkit', bg: 'gitgraph', install: installer('gitkit'), hasDocs: true },
  { id: 'ghscaff', name: 'Ghscaff', number: 'EXP-003', status: 'active', essenceVar: '--gitkit', essenceHex: '#7ee081', github: 'https://github.com/UniverLab/ghscaff', bg: 'scaffold', install: installer('ghscaff'), hasDocs: true },
