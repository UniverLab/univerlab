...
export const experiments: Experiment[] = [
  ...
  { id: 'gitkit', name: 'GitKit', number: 'EXP-003', status: 'active', essenceHex: '#7ee081', github: 'https://github.com/UniverLab/gitkit', bg: 'gitgraph', install: both('gitkit'), hasDocs: true },
  { id: 'ghscaff', name: 'ghScaff', number: 'EXP-004', status: 'active', essenceHex: '#e6c84a', github: 'https://github.com/UniverLab/ghscaff', bg: 'scaffold', install: both('ghscaff'), hasDocs: true },
